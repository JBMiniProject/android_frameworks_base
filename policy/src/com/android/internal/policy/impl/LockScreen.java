...
class LockScreen extends RelativeLayout implements KeyguardScreen {
    ...
    class ElugaViewMethods implements ElugaView.OnTriggerListener, UnlockWidgetCommonMethods {

        private final ElugaView mElugaView;

        ElugaViewMethods(ElugaView elugaView) {
            mElugaView = elugaView;
        }
        /** {@inheritDoc} */
        public void onTrigger(View v, int whichHandle) {
            if (whichHandle == ElugaView.OnTriggerListener.CENTER_HANDLE) {
                requestUnlockScreen();
            }
        }
        ...
        public void onGrabbedStateChange(View v, int grabbedState) {
            ...
            // not grabbed since that can happen when the system (instead of the user)
            // cancels the grab.
            if (grabbedState == ElugaView.OnTriggerListener.CENTER_HANDLE) {
                mCallback.pokeWakelock(STAY_ON_WHILE_GRABBED_TIMEOUT);
            }
        }
    ...
    LockScreen(Context context, Configuration configuration, LockPatternUtils lockPatternUtils,
        ...
        if (Integer.parseInt(android.os.SystemProperties.get("ro.sf.lcd_density")) == 120)
    ...
    private UnlockWidgetCommonMethods createUnlockMethods(View unlockWidget) {
        ...
        } else if (unlockWidget instanceof ElugaView) {
            ElugaView elugaView = (ElugaView) unlockWidget;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(Settings.System.LOCKSCREEN_CUSTOM_TEXT_COLOR), false, this);
            updateSettings();
        }
